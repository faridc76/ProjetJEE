					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form data-toggle="validator" role="form" action="/Projet/ModifPersonalite" method="POST">
								<div class="form-group text-left">
									<label for="inputNamePersonalite" class="control-label">Nom
										de la Personalité</label> <input type="text" class="form-control"
										id="nom" placeholder="Nom de la personalité"
										name="nom" required>
								</div>
								<div class="form-group text-left">
									<label for="inputNiveauPersonalite" class="control-label">Niveau
										de la personalité</label> <input type="number" class="form-control"
										id="niveau" placeholder="Niveau de la pérsonalité" value="document.getElementById('blabla')"
										name="niveau" required>
								</div>
								<div class="form-group text-left">
									<label for="inputDescriptifPersonalite" class="control-label">Descriptif
										de la personalité</label>
